...
export const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Every Sylvan space comes with a free sylvan.live subdomain (e.g., yourname.sylvan.live). If you are on our Pro or Enterprise plans, you can map your own completely custom domain (e.g., community.yourname.com) in just a few clicks. Sylvan handles all SSL certificates and routing automatically.'
  },
  {
    id: 'faq-3',
    category: 'general',
